    ...
    public partial class initdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 1, 25, 21, 34, 8, 683, DateTimeKind.Local).AddTicks(2452), true, new DateTime(2024, 1, 25, 20, 4, 8, 683, DateTimeKind.Local).AddTicks(2392) },
                    { 2, 2, new DateTime(2024, 1, 25, 21, 34, 8, 683, DateTimeKind.Local).AddTicks(2461), false, new DateTime(2024, 1, 25, 20, 4, 8, 683, DateTimeKind.Local).AddTicks(2459) },
                    { 3, 3, new DateTime(2024, 1, 25, 21, 34, 8, 683, DateTimeKind.Local).AddTicks(2465), false, new DateTime(2024, 1, 25, 20, 4, 8, 683, DateTimeKind.Local).AddTicks(2464) },
                    { 4, 1, new DateTime(2024, 1, 25, 23, 34, 8, 683, DateTimeKind.Local).AddTicks(2469), false, new DateTime(2024, 1, 25, 22, 4, 8, 683, DateTimeKind.Local).AddTicks(2468) },
                    { 5, 2, new DateTime(2024, 1, 25, 23, 34, 8, 683, DateTimeKind.Local).AddTicks(2473), false, new DateTime(2024, 1, 25, 22, 4, 8, 683, DateTimeKind.Local).AddTicks(2472) },
                    { 6, 3, new DateTime(2024, 1, 25, 23, 34, 8, 683, DateTimeKind.Local).AddTicks(2477), false, new DateTime(2024, 1, 25, 22, 4, 8, 683, DateTimeKind.Local).AddTicks(2476) }
                });
