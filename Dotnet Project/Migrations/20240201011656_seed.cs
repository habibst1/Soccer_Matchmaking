    ...
    public partial class seed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 2, 1, 3, 46, 56, 70, DateTimeKind.Local).AddTicks(1281), true, new DateTime(2024, 2, 1, 2, 16, 56, 70, DateTimeKind.Local).AddTicks(1220) },
                    { 2, 2, new DateTime(2024, 2, 1, 3, 46, 56, 70, DateTimeKind.Local).AddTicks(1290), false, new DateTime(2024, 2, 1, 2, 16, 56, 70, DateTimeKind.Local).AddTicks(1289) },
                    { 3, 3, new DateTime(2024, 2, 1, 3, 46, 56, 70, DateTimeKind.Local).AddTicks(1295), false, new DateTime(2024, 2, 1, 2, 16, 56, 70, DateTimeKind.Local).AddTicks(1293) },
                    { 4, 1, new DateTime(2024, 2, 1, 5, 46, 56, 70, DateTimeKind.Local).AddTicks(1299), false, new DateTime(2024, 2, 1, 4, 16, 56, 70, DateTimeKind.Local).AddTicks(1298) },
                    { 5, 2, new DateTime(2024, 2, 1, 5, 46, 56, 70, DateTimeKind.Local).AddTicks(1304), false, new DateTime(2024, 2, 1, 4, 16, 56, 70, DateTimeKind.Local).AddTicks(1302) },
                    { 6, 3, new DateTime(2024, 2, 1, 5, 46, 56, 70, DateTimeKind.Local).AddTicks(1308), false, new DateTime(2024, 2, 1, 4, 16, 56, 70, DateTimeKind.Local).AddTicks(1307) }
                });
